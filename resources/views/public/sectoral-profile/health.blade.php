                ...
                <div class="space-y-6 sticky top-6">
                    ...
                    <div class="bg-wabag-green/5 p-6 rounded-xl border border-wabag-green/20">
                        ...
                        <div class="space-y-3">
                            ...
                            <a href="{{ route('sectoral-profile.education') }}" class="flex items-center {{ request()->routeIs('sectoral-profile.education') ? 'bg-green-50 border-wabag-green' : 'bg-white border-gray-200' }} p-3 rounded-lg border hover:border-green-400 transition group sector-link">
                            ...
                            <a href="{{ route('sectoral-profile.infrastructure') }}" class="flex items-center {{ request()->routeIs('sectoral-profile.infrastructure') ? 'bg-orange-50 border-orange-200' : 'bg-white border-gray-200' }} p-3 rounded-lg border hover:border-orange-400 transition group sector-link">
