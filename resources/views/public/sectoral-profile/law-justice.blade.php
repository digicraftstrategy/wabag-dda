...
@section('title', 'Law & Justice | Wabag DDA')
        ...
        <div class="flex flex-col lg:flex-row gap-8">
            ...
            <div class="lg:w-2/3">
                ...
                <nav class="flex mb-6 public-breadcrumb" aria-label="Breadcrumb">
                    <ol class="inline-flex items-center space-x-2 text-sm">
                        ...
                        <li class="text-gray-400">/</li>
                        <li class="text-gray-600 font-medium">Law & Justice</li>
                    </ol>
                </nav>
                ...
                <article class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    <header class="px-6 pt-6 pb-4">
                        ...
                        <h1 class="text-3xl lg:text-4xl font-serif font-bold text-wabag-black">
                            Law & Justice / Peace & Good Order Profile
                        </h1>
                    </header>
                    ...
                    <div class="px-6 pb-8 text-gray-700">
                        ...
                        <p class="mb-6 leading-relaxed">
                            Law and Order is a major development concern in Wabag District.
                            Tribal fighting, limited policing resources, and weak justice systems
                            continue to affect safety, service delivery, and economic activity.
                        </p>
                        ...
                        <p class="mb-4 leading-relaxed">
                            Wabag District has one police station serving the entire electorate.
                            Police manpower, vehicles, and housing remain inadequate.
                        </p>

                        <div class="font-bold text-lg border-b pb-2 mb-3 text-wabag-green">
                            Village Courts & Mediation
                        </div>
                        <p class="mb-4 leading-relaxed">
                            Village Courts are essential for conflict resolution but operate with
                            limited funding, training, and logistical support.
                        </p>

                        <!-- 5. Stats grid -->
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                            <div class="bg-red-100 p-4 rounded-lg border border-red-200">
                                <div class="text-sm font-semibold text-red-700">Police Stations</div>
                                <div class="text-2xl font-bold">1</div>
                            </div>
                            <div class="bg-red-100 p-4 rounded-lg border border-red-200">
                                <div class="text-sm font-semibold text-red-700">Village Courts</div>
                                <div class="text-2xl font-bold">18</div>
                            </div>
                            <div class="bg-red-100 p-4 rounded-lg border border-red-200">
                                <div class="text-sm font-semibold text-red-700">Conflict Hotspots</div>
                        ...
                        <div class="overflow-x-auto mb-6">
                            <table class="min-w-full">
                                <thead class="bg-gray-50">
                                    <tr>
                                        <th class="py-3 px-4 text-left text-sm font-semibold">Institution</th>
                                        <th class="py-3 px-4 text-left text-sm font-semibold">Status</th>
                                        <th class="py-3 px-4 text-left text-sm font-semibold">Remarks</th>
                                    </tr>
                                </thead>
                                <tbody class="divide-y">
                                    <tr>
                                        <td class="py-3 px-4">Police Station (Wabag)</td>
                                        <td class="py-3 px-4">Operational</td>
                                        <td class="py-3 px-4">Under-resourced</td>
                                    </tr>
                                    <tr>
                                        <td class="py-3 px-4">Village Courts</td>
                                        <td class="py-3 px-4">Active</td>
                                        <td class="py-3 px-4">Require support</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                        ...
                        <div class="bg-red-50 border-l-4 border-red-400 p-4">
                            <p class="text-sm text-red-800">
                                <strong>Challenges:</strong> Tribal conflicts, youth involvement in violence,
                                limited police transport, and weak enforcement of court decisions.
                            </p>
                        </div>
            ...
            <div class="lg:w-1/3 space-y-6">
                ...
                <div class="bg-red-50 p-6 rounded-xl border border-red-200">
                    <h3 class="text-lg font-bold text-red-700 mb-3">Quick Stats</h3>
                    <div class="space-y-2 text-sm">
                        <div class="flex justify-between"><span>Police Stations</span><span class="font-semibold">1</span></div>
                        <div class="flex justify-between"><span>Village Courts</span><span class="font-semibold">18</span></div>
                        <div class="flex justify-between"><span>Conflict Areas</span><span class="font-semibold">5+</span></div>
                    </div>
                </div>

                <!-- 10. Contact block -->
                <div class="bg-gray-50 p-6 rounded-xl border">
                    <h3 class="text-lg font-bold text-wabag-green mb-3">Contact – Law & Justice</h3>
                    <p class="text-sm">Wabag Police Station<br>Enga Province</p>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-xl border">
                    ...
                    <ul class="text-sm space-y-2">
                        <li>Provincial Law & Order Plan</li>
                        <li>Village Courts Act (PNG)</li>
                        <li>Peace & Good Order Strategy</li>
                    </ul>
                </div>
